...
export const EMAIL_VALIDATION =
  import.meta.env.VITE_REGISTRATION_REVIEW_EMAIL ||
  "info@mischtisch-sachsen.de";
export const EMAIL_INTERNAL =
  import.meta.env.VITE_MAINCOMPANY_EMAIL ||
  "info@ldintertech.com";
